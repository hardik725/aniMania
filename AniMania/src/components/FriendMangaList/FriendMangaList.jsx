...
function FriendsMangaList({ username, onLogout }) {
              ...
              {mangaDetails.map((manga, index) => (
                <tr key={manga.Name} className="text-center">
                  ...
                  <td className="py-2 px-4 border-b border-gray-200 flex items-center">
                    ...
                    <div>
                      <Link to={`/AniDetails/${manga.Name}`} className="font-bold text-start">
                        {manga.Name}
                      </Link>
...
export default FriendsMangaList;

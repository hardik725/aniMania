...
const ChatBot = () => {
  ...
  return (
<div className="fixed bottom-4 right-4 z-50 w-[90%] sm:w-auto mx-auto">
  {/* Chatbot Icon */}
  {!isChatOpen && (
    <button
  ...
  {/* Chatbot Window */}
  {isChatOpen && (
    <div className="bg-gray-100 rounded-lg shadow-md overflow-hidden w-full sm:w-96 max-w-full mx-auto">
      {/* Header */}

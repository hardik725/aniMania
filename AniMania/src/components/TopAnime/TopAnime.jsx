          ...
          try {
              for (let rank = 1; rank <= 50; rank++) {
                  ...
                  if (data && typeof data === 'object') {
                      ...
                      initialStatuses[data.Name] = true;
                  } else {
              ...
              userAnimeList.forEach(userAnime => {
                  if (updatedStatuses[userAnime.title]) {
                      updatedStatuses[userAnime.title] = false;
                  }
              });
      ...
      <tbody>
        {animeList.map((anime, index) => (
          <tr key={index} className="text-center">
            ...
            <td className="py-1 px-2 border-b border-gray-200">{anime.Rating}</td>
              ...
              {animeStatuses[anime.Name] ? (
                <>
                  ...
                  <select
                    ...
                    className={`ml-2 border rounded px-2 py-1 ${isMobile ? 'text-xs' : ''}`}
                  >
